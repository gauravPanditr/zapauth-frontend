    ...
    <div className="flex min-h-screen bg-gray-950 text-white">
      ...
      <aside className="w-64 border-r border-gray-800 p-6">
        ...
        <ul className="space-y-3">
          ...
          className="text-gray-400 cursor-pointer">Settings</li>
        </ul>
      </aside>
      ...
      <main className="flex-1 p-10">
        ...
        <div className="flex gap-6 border-b border-gray-800 mb-6">
          ...
          <button className="text-gray-400">
            Usage <span className="ml-2 text-xs bg-yellow-500 text-black px-2 rounded">Coming Soon</span>
          </button>
          <button className="text-gray-400">
            Security Logs <span className="ml-2 text-xs bg-yellow-500 text-black px-2 rounded">Coming Soon</span>
          </button>
        </div>
        ...
        <div className="flex gap-4 mb-6">
          ...
          />
          <button className="bg-gray-700 px-6 rounded">
            Search
          </button>
        </div>
