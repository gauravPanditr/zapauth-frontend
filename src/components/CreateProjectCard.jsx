...
export default function CreateProjectCard() {
  ...
  return (
    ...
    className="flex flex-col items-center justify-center bg-white/5 border border-white/10 rounded-2xl hover:border-violet-400/40 transition cursor-pointer">
